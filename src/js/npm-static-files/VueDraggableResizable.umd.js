...
// CONCATENATED MODULE: ./src/components/vue-draggable-resizable.vue?vue&type=template&id=7c4874c7&
...
/* harmony default export */ var vue_draggable_resizablevue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    handles: {
      ...
      validator: function validator(val) {
        var s = new set_default.a(['tl', 'tm', 'tr', 'mr', 'br', 'bm', 'bl', 'ml']);
        return new set_default.a(val.filter(function (h) {
          return s.has(h);
        })).size === val.length;
      }
    },
  ...
  methods: {
    ...
    getParentSize: function getParentSize() {
      ...
      if (parent === true) {
        ...
        return [parse_int_default()(style.getPropertyValue('width'), 10), parse_int_default()(style.getPropertyValue('height'), 10)];
      }
      ...
      if (typeof parent === 'string') {
        ...
        if (!(parentNode instanceof HTMLElement)) {
          throw new Error("The selector ".concat(parent, " does not match any element"));
        }
    ...
    handleUp: function handleUp(e) {
      ...
      if (this.dragging) {
        this.dragging = false;
        this.$emit('dragstop', this.left, this.top, this.width, this.height, this);
      }
...
component.options.__file = "vue-draggable-resizable.vue"
